import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@v12/contracts";
import { resolveRemotePairingTarget } from "@v12/shared/remote";
...
>()("@v12/client-runtime/connection/onboarding/ConnectionOnboarding") {}
