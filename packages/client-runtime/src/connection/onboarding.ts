import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@v12code/contracts";
import { resolveRemotePairingTarget } from "@v12code/shared/remote";
...
>()("@v12code/client-runtime/connection/onboarding/ConnectionOnboarding") {}
