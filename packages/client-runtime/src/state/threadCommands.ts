...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    startLocalMultitask: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:start-local-multitask",
      execute: (input: StartLocalMultitaskInput) => startLocalMultitask(input),
      scheduler,
