...
- review threads/comments/diffs: key by provider CR ID and head SHA/version when available; fetch on demand for V12 Review
...
- The provider API includes the review operations needed by future V12 Review work, even if they are capability-gated.
