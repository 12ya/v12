# V12 Mobile Terminal Native Module
...
fork, with V12's iOS 16 compatibility patch applied. `V12TerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/v12-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/v12-terminal/scripts/build-libghostty-android.sh
```
