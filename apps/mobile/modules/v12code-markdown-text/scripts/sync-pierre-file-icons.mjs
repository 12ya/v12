...
const customSprite = webIconSource.match(/const V12CODE_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the V12Code Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "v12code-file-icon-agents",
  claude: "v12code-file-icon-claude",
  package: "v12code-file-icon-package-json",
  pnpm: "v12code-file-icon-pnpm",
  readme: "v12code-file-icon-readme",
  tsconfig: "v12code-file-icon-tsconfig",
};
