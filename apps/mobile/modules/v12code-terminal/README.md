# V12Code Mobile Terminal Native Module
...
fork, with V12Code's iOS 16 compatibility patch applied. `V12CodeTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/v12code-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/v12code-terminal/scripts/build-libghostty-android.sh
```
