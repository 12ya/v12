...
const customSprite = webIconSource.match(/const V12_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the V12 Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
...
const customIcons = {
  agents: "v12-file-icon-agents",
  claude: "v12-file-icon-claude",
  package: "v12-file-icon-package-json",
  pnpm: "v12-file-icon-pnpm",
  readme: "v12-file-icon-readme",
  tsconfig: "v12-file-icon-tsconfig",
};
