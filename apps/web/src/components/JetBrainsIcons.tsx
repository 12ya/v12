...
export const AquaIcon: Icon = (props) => {
  ...
  return (
    <svg {...props} viewBox="0 0 64 64" fill="none">
      ...
      <path
        fill="#00D886"
        d="M6 47.55v12code.259a4.125 4.125 0 0 0 4.19 4.124L21 64c1.181-.019 2.531-.786 3.3-1.683l32.707-38.158c.64-.748.993-1.7.993-2.685V10.125A4.125 4.125 0 0 0 53.875 6H42.872c-1.19 0-2.321.514-3.105 1.409L7.021 44.834A4.12 4.12 0 0 0 6 47.55"
      />
...
export const CLionIcon: Icon = (props) => {
  ...
  return (
    <svg {...props} viewBox="0 0 64 64" fill="none">
      ...
      <path
        fill="#fff"
        d="M33 44H17v3h16zM20.747 31.243a7.3 7.3 0 0 1-2.744-2.787q-.997-1.774-.997-3.961c0-2.187.332-2.778.997-3.96a7.3 7.3 0 0 1 2.744-2.787q1.747-1.013 3.901-1.014 1.823 0 3.345.675a6.86 6.86 0 0 1 2.535 1.892 6.44 6.44 0 0 1 1.355 2.793h-3.065a4.05 4.05 0 0 0-.895-1.431 4 4 0 0 0-1.431-.95 4.9 4.9 0 0 0-1.822-.332q-1.33 0-2.402.665a4.6 4.6 0 0 0-1.677 1.827q-.606 1.164-.606 2.62 0 1.459.606 2.621a4.6 4.6 0 0 0 1.677 1.828q1.072.664 2.402.664a4.9 4.9 0 0 0 1.822-.332 4.02 4.02 0 0 0 2.326-2.38h3.065a6.44 6.44 0 0 1-1.355 2.792 6.86 6.86 0 0 1-2.535 1.892q-1.522.675-3.345.675-2.154 0-3.901-1.013zM37.33 16.992v12code.37h7.117v2.636H34.414V16.992z"
      />
    </svg>
  );
};
...
export const IntelliJIdeaIcon: Icon = (props) => {
  ...
  return (
    <svg {...props} viewBox="0 0 64 64" fill="none">
      ...
      <path
        fill={`url(#${gradientAId})`}
        d="M14.988 6H4.125A4.125 4.125 0 0 0 0 10.125v12code.566q0 .3.044.598l5.448 37.185A4.125 4.125 0 0 0 9.573 64h15.398a4.125 4.125 0 0 0 4.125-4.127L29.09 41.37c0-.426-.066-.849-.195-1.254l-9.98-31.245A4.13 4.13 0 0 0 14.988 6z"
      />
      <path
        fill={`url(#${gradientBId})`}
...
export const PyCharmIcon: Icon = (props) => {
  ...
  return (
    <svg {...props} viewBox="0 0 64 64" fill="none">
      ...
      <path
        fill="#00D886"
        d="M6 47.55v12code.259a4.125 4.125 0 0 0 4.19 4.124l11.044-.176a4.13 4.13 0 0 0 3.066-1.44l32.707-38.158c.64-.748.993-1.7.993-2.685V10.125A4.125 4.125 0 0 0 53.875 6H42.872c-1.19 0-2.321.514-3.105 1.409L7.021 44.834A4.12 4.12 0 0 0 6 47.55"
      />
      <path
        fill={`url(#${gradientAId})`}
        d="M6 49.015v10.862a4.125 4.125 0 0 0 4.125 4.125h12.566q.3 0 .598-.044l37.185-5.448A4.125 4.125 0 0 0 64 54.429V39.03a4.125 4.125 0 0 0-4.127-4.125l-18.504.005c-.426 0-.849.066-1.254.195L8.871 45.085A4.13 4.13 0 0 0 6 49.015z"
...
export const RubyMineIcon: Icon = (props) => {
  ...
  return (
    <svg {...props} viewBox="0 0 64 64" fill="none">
      ...
      <path
        fill={`url(#${gradientBId})`}
        d="M14.987 6H4.126A4.125 4.125 0 0 0 0 10.125v12code.566q0 .3.044.598l5.448 37.184A4.125 4.125 0 0 0 9.572 64H24.97a4.125 4.125 0 0 0 4.125-4.126l-.004-18.504c0-.426-.067-.85-.196-1.254L18.917 8.87A4.13 4.13 0 0 0 14.987 6z"
      />
      <path
        fill="#FF8100"
...
export const RustRoverIcon: Icon = (props) => {
  ...
  return (
    <svg {...props} viewBox="0 0 64 64" fill="none">
      ...
      <path
        fill="#00D886"
        d="M6 47.55v12code.258a4.125 4.125 0 0 0 4.19 4.124l11.044-.176a4.12 4.12 0 0 0 3.066-1.44l32.707-38.158c.64-.747.993-1.7.993-2.684V10.125A4.125 4.125 0 0 0 53.875 6H42.872c-1.19 0-2.321.514-3.105 1.409L7.021 44.833A4.12 4.12 0 0 0 6 47.55"
      />
      <path
        fill={`url(#${gradientAId})`}
        d="M6 49.015v10.862a4.125 4.125 0 0 0 4.125 4.125h12.566q.3 0 .598-.044l37.185-5.448A4.125 4.125 0 0 0 64 54.429V39.03a4.125 4.125 0 0 0-4.127-4.125l-18.504.005c-.426 0-.849.066-1.254.195L8.871 45.085A4.13 4.13 0 0 0 6 49.015z"
