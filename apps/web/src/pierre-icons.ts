...
const PIERRE_ICON_SPRITE_ID = "v12code-pierre-file-icon-sprite";

const V12CODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="v12code-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="v12code-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="v12code-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="v12code-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="v12code-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="v12code-file-icon-pnpm" viewBox="0 0 32 32">
...
export const V12CODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: V12CODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "v12code-file-icon-package-json",
    "tsconfig.json": "v12code-file-icon-tsconfig",
    "agents.md": "v12code-file-icon-agents",
    "claude.md": "v12code-file-icon-claude",
    "readme.md": "v12code-file-icon-readme",
    "pnpm-lock.yaml": "v12code-file-icon-pnpm",
    "pnpm-workspace.yaml": "v12code-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(V12CODE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${V12CODE_FILE_ICON_SPRITE}`;
