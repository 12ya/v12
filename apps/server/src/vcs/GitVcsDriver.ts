  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `v12code-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "V12Code",
        GIT_AUTHOR_EMAIL: "v12code@users.noreply.github.com",
        GIT_COMMITTER_NAME: "V12Code",
        GIT_COMMITTER_EMAIL: "v12code@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `v12code checkpoint ref=${input.checkpointRef}`;
