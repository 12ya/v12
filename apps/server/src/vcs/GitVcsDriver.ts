  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `v12-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "V12",
        GIT_AUTHOR_EMAIL: "v12@users.noreply.github.com",
        GIT_COMMITTER_NAME: "V12",
        GIT_COMMITTER_EMAIL: "v12@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `v12 checkpoint ref=${input.checkpointRef}`;
