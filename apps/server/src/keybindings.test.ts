import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@v12code/contracts";
...
import { KeybindingsConfigError } from "@v12code/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "v12code-keybindings-test-",
        }),
      ),
    ),
  );
