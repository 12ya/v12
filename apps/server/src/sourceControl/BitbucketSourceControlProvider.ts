...
import { SourceControlProviderError, type ChangeRequest } from "@v12code/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set V12CODE_BITBUCKET_EMAIL and V12CODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
