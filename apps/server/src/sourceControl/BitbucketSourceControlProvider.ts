...
import { SourceControlProviderError, type ChangeRequest } from "@v12/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set V12_BITBUCKET_EMAIL and V12_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
