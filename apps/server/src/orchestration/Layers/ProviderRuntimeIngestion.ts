...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.V12CODE_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
      ...
      return [
        {
          ...
          payload: {
            ...
            ...(event.payload.detail ? { detail: truncateToolDetail(event.payload.detail) } : {}),
