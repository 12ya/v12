...
const OVERLAY_ATTRIBUTE = "data-v12-annotation-ui";
const Z_INDEX_OVERLAY = 2147483646;
const PRIMARY = "var(--v12-primary)";
const PRIMARY_FILL = "color-mix(in srgb, var(--v12-primary) 10%, transparent)";
...
const applyAnnotationTheme = (
  ...
  const variables = {
    "--v12-radius": theme.radius,
    "--v12-background": theme.background,
    "--v12-foreground": theme.foreground,
    "--v12-popover": theme.popover,
    "--v12-popover-foreground": theme.popoverForeground,
    "--v12-primary": theme.primary,
    "--v12-primary-foreground": theme.primaryForeground,
    "--v12-muted": theme.muted,
    "--v12-muted-foreground": theme.mutedForeground,
    "--v12-accent": theme.accent,
    "--v12-accent-foreground": theme.accentForeground,
    "--v12-border": theme.border,
    "--v12-input": theme.input,
    "--v12-ring": theme.ring,
    "--v12-font-sans": theme.fontSans,
    "--v12-font-mono": theme.fontMono,
  };
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-v12-annotation-tool", tool);
  };
      ...
      if (isUsableRect(rect)) {
        ...
        if (found === 0) {
          ...
          const regionBox = createBox(
            PRIMARY,
            "color-mix(in srgb, var(--v12-primary) 6%, transparent)",
          );
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-v12-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
