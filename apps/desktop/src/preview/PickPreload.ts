...
const OVERLAY_ATTRIBUTE = "data-v12code-annotation-ui";
const Z_INDEX_OVERLAY = 2147483646;
const PRIMARY = "var(--v12code-primary)";
const PRIMARY_FILL = "color-mix(in srgb, var(--v12code-primary) 10%, transparent)";
...
const applyAnnotationTheme = (
  ...
  const variables = {
    "--v12code-radius": theme.radius,
    "--v12code-background": theme.background,
    "--v12code-foreground": theme.foreground,
    "--v12code-popover": theme.popover,
    "--v12code-popover-foreground": theme.popoverForeground,
    "--v12code-primary": theme.primary,
    "--v12code-primary-foreground": theme.primaryForeground,
    "--v12code-muted": theme.muted,
    "--v12code-muted-foreground": theme.mutedForeground,
    "--v12code-accent": theme.accent,
    "--v12code-accent-foreground": theme.accentForeground,
    "--v12code-border": theme.border,
    "--v12code-input": theme.input,
    "--v12code-ring": theme.ring,
    "--v12code-font-sans": theme.fontSans,
    "--v12code-font-mono": theme.fontMono,
  };
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-v12code-annotation-tool", tool);
  };
      ...
      if (isUsableRect(rect)) {
        ...
        if (found === 0) {
          ...
          const regionBox = createBox(
            PRIMARY,
            "color-mix(in srgb, var(--v12code-primary) 6%, transparent)",
          );
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-v12code-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
