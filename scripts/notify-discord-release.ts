  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new V12 prerelease is available for nightly testers."
          : "A new V12 latest release is available.",
...
).pipe(Command.withDescription("Post a V12 release announcement to Discord."));
