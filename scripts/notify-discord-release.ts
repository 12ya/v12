  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new V12Code prerelease is available for nightly testers."
          : "A new V12Code latest release is available.",
...
).pipe(Command.withDescription("Post a V12Code release announcement to Discord."));
