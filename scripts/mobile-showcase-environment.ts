// @effect-diagnostics nodeBuiltinImport:off globalDate:off - This host-side fixture creates an isolated local V12Code environment.
...
export const SHOWCASE_PROJECT_ID = "v12code";
...
export const SHOWCASE_TERMINAL_BUFFER = [
  "\u001b[38;5;75m~/Code/v12code\u001b[0m \u001b[38;5;212mfeat/remote-command-center\u001b[0m",
  "$ vp test run --changed",
  "",
  "  \u001b[38;5;117mv12code-mobile\u001b[0m      184 passed",
...
const PROJECT_FAVICONS = {
  v12code: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <defs><pattern id="grid" width="16" height="16" patternUnits="userSpaceOnUse"><path d="M16 0H0V16" stroke="#315B83" stroke-width="1"/></pattern></defs>
  <rect width="128" height="128" rx="24" fill="#0B2340"/>
  <rect width="128" height="128" rx="24" fill="url(#grid)"/>
  <path d="M18 71H27L33 94L39 71H48L39 104H27L18 71ZM50 43L60 33H72V104H60V50H50V43ZM77 43L87 33H102L110 41V61L89 89V92H110V104H77V85L98 57V46H89V57H77V43Z" fill="#F8F7F2"/>
</svg>`,
...
export const SHOWCASE_PROJECTS = [
  {
    ...
    title: "V12Code",
    directory: "v12code",
    repositoryUrl: "https://github.com/12ya/v12code.git",
    favicon: PROJECT_FAVICONS.v12code,
  },
  {
    id: "react",
    title: "React",
...
async function seedV12CodeWorkspace(workspaceRoot: string): Promise<void> {
  ...
  await NodeFSP.writeFile(
    ...
    `${JSON.stringify({ name: "v12code", private: true, scripts: { test: "vp test" } }, null, 2)}\n`,
  );
  await NodeFSP.writeFile(NodePath.join(workspaceRoot, "favicon.svg"), PROJECT_FAVICONS.v12code);
  await NodeFSP.writeFile(
...
async function seedCompanionWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the V12Code mobile screenshot harness.\n`,
  );
  await initializeRepository({
...
export async function seedShowcaseEnvironment(input: {
  ...
  if (primaryProject.id === SHOWCASE_PROJECT_ID) {
    await seedV12CodeWorkspace(workspaceRoot);
  }
  await Promise.all(
    projects
