...
export interface V12PublicConfig {
...
export function loadRepoEnv({
  ...
  return {
    ...
    ...(config.clerkPublishableKey
      ? {
          V12_CLERK_PUBLISHABLE_KEY: config.clerkPublishableKey,
    ...
    ...(config.clerkJwtTemplate
      ? {
          V12_CLERK_JWT_TEMPLATE: config.clerkJwtTemplate,
...
export function resolvePublicConfig(...sources: readonly Environment[]): V12PublicConfig {
  return {
