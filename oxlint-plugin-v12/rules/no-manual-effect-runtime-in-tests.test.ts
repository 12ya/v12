...
const rule = createOxlintRuleHarness("v12/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("v12/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("v12/no-manual-effect-runtime-in-tests");
