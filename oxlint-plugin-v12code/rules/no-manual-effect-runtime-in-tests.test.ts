...
const rule = createOxlintRuleHarness("v12code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("v12code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("v12code/no-manual-effect-runtime-in-tests");
