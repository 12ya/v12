...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@v12/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "v12-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "v12-relay-dpop-access+jwt";
