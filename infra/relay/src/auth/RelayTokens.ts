...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@v12code/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "v12code-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "v12code-relay-dpop-access+jwt";
...
>()("v12code-relay/auth/RelayTokens") {}
